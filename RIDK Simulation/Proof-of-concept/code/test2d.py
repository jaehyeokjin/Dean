...
params_m = {  # model parameters
    ...
    "N": 50,
    "mass":1,
    "sigma": 0.000001, #1.0 for old
    "reaction_rate":0.0,
    "Lx": 2.0 * pi,
    "Ly": 2.0 * pi,
    "epsilon": 0.05,
    "final_time": 500, # Original value is 1
    "initial_rho": test_rho_2d,
    "initial_j": zero_j_2d,
    #"inter_pair": "10*exp(-r**(-2)*0.0292)",
    "pair": "10*exp(-0.5*(r**2)/(1/4)**2)",
...
params_n = {  # numerical-discretisation parameters
    ...
    "no_x": 50,
    "no_y": 50,
    "no_t": 50001, #original 101
    "screen_output_steps": 20,
    "convolution_radius": 0.25,
    "noise_truncation": 40,
    "rho_thresh":0, 
...
print("Time step:",dt)
#
outfile=File("./simple-2d/0.25/r_large.pvd")
